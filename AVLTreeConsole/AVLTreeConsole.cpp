// AVLTree.cpp : 此檔案包含 'main' 函式。程式會於該處開始執行及結束執行。
//
...
#define INSERT_COUNT 720
#define REMOVE_COUNT 478
...
int main()
{
	...
	random_device dev;
	mt19937 rng(dev());
	uniform_int_distribution<std::mt19937::result_type> insertRandom(0, 1234184); // distribution in range [1, 6]
